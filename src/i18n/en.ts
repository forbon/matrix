...
const en: Dict = {
  ...
  'action.moveTo': 'Move',
  'action.close': 'Close',
  'action.toBacklog': 'To backlog',
  'action.archive': 'Archive',
  'action.restore': 'Restore',
  'action.promote': 'Sort in',
  'action.archiveCompleted': 'Archive completed',
  'action.collapseBacklog': 'Collapse backlog',
  'action.expandBacklog': 'Expand backlog',
